...
def display_sentiment_summary(commentslst):
    ...
    positive_percentage = (positive_count / (num_comments+1)) * 100
    neutral_percentage = (neutral_count / (num_comments+1)) * 100
    negative_percentage = (negative_count / (num_comments+1)) * 100
